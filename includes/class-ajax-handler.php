...
class WP_Dapp_Ajax_Handler {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_wpdapp_verify_keychain', array( $this, 'ajax_verify_keychain' ) );
		add_action( 'wp_ajax_wpdapp_verify_posts', array( $this, 'ajax_verify_posts' ) );
		add_action( 'wp_ajax_wpdapp_prepare_post', array( $this, 'ajax_prepare_post' ) );
		add_action( 'wp_ajax_wpdapp_update_post_meta', array( $this, 'ajax_update_post_meta' ) );
		add_action( 'wp_ajax_wpdapp_sync_comments', array( $this, 'ajax_sync_comments' ) );
		add_action( 'wp_ajax_nopriv_wpdapp_sync_comments', array( $this, 'ajax_sync_comments' ) );
		add_action( 'wp_ajax_wpdapp_render_hive_comments', array( $this, 'ajax_render_hive_comments' ) );
		add_action( 'wp_ajax_nopriv_wpdapp_render_hive_comments', array( $this, 'ajax_render_hive_comments' ) );
	...
	public function ajax_update_post_meta() {
		...
		$post_id   = isset( $_POST['post_id'] ) ? intval( $_POST['post_id'] ) : 0;
		$hive_data = isset( $_POST['hive_data'] ) ? $_POST['hive_data'] : array();
