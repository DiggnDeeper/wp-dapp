...
class WP_Dapp_Settings_Page {
	...
	public function register_settings() {
		...
		add_settings_field(
			...
			'wpdapp-settings',
			'wpdapp_account_section',
			array( 'field' => 'hive_account' )
		);

		add_settings_field(
			'keychain_status',
			'Keychain Status',
			array( $this, 'render_keychain_status' ),
			'wpdapp-settings',
			'wpdapp_account_section'
		);
		...
		add_settings_section(
			...
			array( $this, 'beneficiary_section_callback' ),
			'wpdapp-settings'
		);
		...
		add_settings_field(
			...
			'wpdapp_beneficiary_section',
			array(
				'field' => 'enable_default_beneficiary',
				'type'  => 'checkbox',
			)
		);
		...
		add_settings_field(
			...
			'wpdapp-settings',
			'wpdapp_beneficiary_section',
			array( 'field' => 'default_beneficiary_account' )
		);
		...
		add_settings_section(
			...
			'Comment Sync',
			array( $this, 'comment_sync_section_callback' ),
			'wpdapp-settings'
		);
		...
		add_settings_field(
			...
			'wpdapp_comment_sync_section',
			array(
				'field' => 'enable_comment_sync',
				'type'  => 'checkbox',
				'label' => __( 'Mirror Hive replies into WordPress comments', 'wp-dapp' ),
			)
		);
	...
	public function sanitize_options( $options ) {
		...
		$existing_options = get_option( 'wpdapp_options', array() );
		...
		$allowed_frontends = array( 'peakd', 'hive.blog', 'ecency' );
	...
	public function render_field( $args ) {
		...
		switch ( $type ) {
			...
			case 'select':
				$options_map = isset( $args['options'] ) && is_array( $args['options'] ) ? $args['options'] : array();
				if ( empty( $value ) ) {
					$value = 'peakd';
				}
